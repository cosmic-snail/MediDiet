...
class OpenAICompatibleLLMProviderTest(unittest.TestCase):
    def test_config_loads_from_environment_without_enabling_patient_id(self):
        ...
        env = {
            ...
            "MEDIDIET_LLM_RETRY_ATTEMPTS": "5",
            "MEDIDIET_LLM_RETRY_BACKOFF_SECONDS": "0.75",
        }
    ...
    def test_openai_provider_retries_transient_http_error(self):
        import json
        import urllib.error
        from unittest.mock import patch
    ...
    def test_openai_provider_retries_empty_message_content(self):
        import json
        from unittest.mock import patch
        ...
        responses = [FakeHTTPResponse(""), FakeHTTPResponse("{\"answer\": \"ok\"}")]
    ...
    def test_openai_provider_retries_incomplete_read(self):
        import http.client
        import json
        from unittest.mock import patch
